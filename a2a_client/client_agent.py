...
Usage (after starting the OMHC A2A server):
  ...
  export OMC_A2A_BASE_URL=http://127.0.0.1:8001
  uv run adk web --agent-module a2a_client.client_agent
...
#
# Example:
#   OMC_A2A_SERVER_HOST=127.0.0.1
#   OMC_A2A_SERVER_PORT=8001
#   -> OMC_A2A_BASE_URL=http://127.0.0.1:8001
#
OMC_A2A_BASE_URL = os.getenv("OMC_A2A_BASE_URL", "http://127.0.0.1:8001")

# The to_a2a(...) helper exposes the agent under:
#   /a2a/<agent_name>/.well-known/agent.json
#
omc_agent_card_url = (
    f"{OMC_A2A_BASE_URL}/a2a/open_mhc_orchestrator{AGENT_CARD_WELL_KNOWN_PATH}"
)
